...
class NCRActionCatalogView{ //give a name to this class on every specific catalog
    constructor(){
        this.create_btn = Selector('a').withAttribute('href','#!/catalogs/ncraction/add')
...
export default new NCRActionCatalogView