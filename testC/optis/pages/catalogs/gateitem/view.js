...
class GateItemCatalogView{ //give a name to this class on every specific catalog
    constructor(){
        this.create_btn = Selector('a').withAttribute('href','#!/catalogs/gate/item/add')
...
export default new GateItemCatalogView