...
class ShipToCatalogView{ //give a name to this class on every specific catalog
    constructor(){
        this.create_btn = Selector('a').withAttribute('href','#!/catalogs/shipto/add')
...
export default new ShipToCatalogView