...
class NCTypeCatalogView{ //give a name to this class on every specific catalog
    constructor(){
        this.create_btn = Selector('a').withAttribute('href','#!/catalogs/nctype/add')
...
export default new NCTypeCatalogView