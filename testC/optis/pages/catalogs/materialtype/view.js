...
class MaterialTypeCatalogView{ //give a name to this class on every specific catalog
    constructor(){
        this.create_btn = Selector('a').withAttribute('href','#!/catalogs/materialtype/add')
...
export default new MaterialTypeCatalogView