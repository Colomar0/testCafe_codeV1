...
class EventTypeCatalogView { //give a name to this class on every specific catalog
    constructor(){
        this.create_btn = Selector('a').withAttribute('href','#!/catalogs/eventtype/add')
...
export default new EventTypeCatalogView