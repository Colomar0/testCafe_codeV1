...
class MaterialsCatalogView{ //give a name to this class on every specific catalog
    constructor(){
        this.create_btn = Selector('a').withAttribute('href','#!/catalogs/materials/add')
...
export default new MaterialsCatalogView