...
class OperationTypeCatalogView { //give a name to this class on every specific catalog
    constructor(){
        this.create_btn = Selector('a').withAttribute('href','#!/catalogs/operationtype/add')
...
export default new OperationTypeCatalogView