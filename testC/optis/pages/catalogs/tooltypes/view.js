...
class ToolTypeCatalogView{ //give a name to this class on every specific catalog
    constructor(){
        this.create_btn = Selector('a').withAttribute('href','#!/catalogs/tooltype/add')
...
export default new ToolTypeCatalogView